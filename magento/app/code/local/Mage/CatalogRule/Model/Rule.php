...
/**
 * Extended: This file is extended due to a problem in the applyAllRulesToProduct method.
 * We flagged this as a core bug, hence we 'extended' this by copying the file
 * local/Mage instead of a normal XML rewrite extend.
 */
class Mage_CatalogRule_Model_Rule extends Mage_Rule_Model_Rule
{
    ...
    public function applyAll()
    {
        ...
        if ($indexProcess && $indexProcess->getMode() != 'manual') {
