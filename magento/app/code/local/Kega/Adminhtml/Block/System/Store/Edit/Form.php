 ...
 */
class Kega_Adminhtml_Block_System_Store_Edit_Form extends Mage_Adminhtml_Block_System_Store_Edit_Form
{
    /**
     * Prepare form data
     *
    ...
    protected function _prepareForm()
    {
        ...
        if ($showWebsiteFieldset) {
            ...
            $fieldset->addField('website_host', 'textarea', array(
                'name'      => 'website[host]',
                'label'     => Mage::helper('core')->__('Host'),
                'value'     => $websiteModel->getHost(),
                'required'  => true,
                'disabled'  => $websiteModel->isReadOnly(),
            ));
