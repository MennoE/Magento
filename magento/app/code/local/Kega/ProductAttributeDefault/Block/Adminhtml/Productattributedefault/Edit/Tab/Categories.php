...
class Kega_ProductAttributeDefault_Block_Adminhtml_Productattributedefault_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('kega_productattributedefault/productattributedefault/edit/tab/categories.phtml');
    }
