<?php
/**
 * MR: Extended to add slash at the end of this line:
 * 'onclick'   => "widgetTools.openDialog('" . $this->getConfig('widget_window_url') . "widget_target_id/"
 * in method _getPluginButtonsHtml()
 * 
 * I did this because this is a bug, and without this escaping we can't insert widgets into a banner!
 */
class Varien_Data_Form_Element_Editor extends Varien_Data_Form_Element_Textarea
{
     ...
     * 
     * Kega: Extended to add slash at the end of this line:
     * 'onclick'   => "widgetTools.openDialog('" . $this->getConfig('widget_window_url') . "widget_target_id/"
     * I did this because this is a bug, and without this escaping we can't insert widgets into a banner!
     *
